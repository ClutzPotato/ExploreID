                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= substr($data->request_info, 0, 150) ?>...</td>
            ...
            <form action="<?= base_url() ?>/request/saveEditData" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <div class="col">
                            <label class="col col-form-label">Request Name</label>
                            <div class="col"><input type="text" class="form-control" id="request_name" name="request_name" placeholder="request name" readonly></div>
                        </div>
                        <div class="col">
                            <label class="col col-form-label">Request Email</label>
                            <div class="col"><input type="text" class="form-control" id="request_email" name="request_email" placeholder="request email" readonly></div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col">
                            <label class="col col-form-label">Province ID</label>
                            <div class="col">
                                <fieldset>
                        ...
                        <div class="col">
                            <label class="col col-form-label">For Table</label>
                            <div class="col">
                                <fieldset>
                    ...
                    <div class="form-group row">
                        <div class="col">
                            <label class="col col-form-label">Title/Name</label>
                            <div class="col"><input type="text" class="form-control" id="request_title" name="request_title" placeholder="request title" required></div>
                        </div>
                        <div class="col">
                            <label class="col col-form-label">Image</label>
                            <div class="col">
                                <a id="request_img" href="" data-lightbox="image-1" class="form-control">Click to View</a>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea type="text" class="form-control" id="request_info" name="request_info" placeholder="request info" required cols="30" rows="6"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <fieldset>
                                <select name="request_status" id="request_status" class="custom-select" aria-label="province" onchange="this.form.click()" required>
                ...
                <div class="modal-footer">
                    <button type="submit" name="buttontype" value='accept' class="btn btn-success" style="margin-right: auto;">Accept & Transfer to Main Tables</button>
