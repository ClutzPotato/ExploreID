            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="listing-item">
                  <?php
                  foreach ($latestfood as $row) { ?> 
                    <div class="left-image">
                      <a href="<?= base_url() ?>/content/?prov=<?= $row->province_id ?>"><img src="<?= base_url() ?>/database/food/food_<?= $row->food_id ?>.jpg" alt=""></a>
                    </div>
                    <div class="right-content align-self-center">
                      <a href="../../#">
                        <h4><?= $row->food_name ?></h4>
                      </a>
                      <h6><?= substr($row->food_info, 0, 200) ?>...</h6>
                    </div>
                  <?php } ?>
                </div>
              </div>
              <div class="col-lg-12">
                <div class="listing-item">
                  <?php
                  foreach ($latestlandmark as $row) { ?> 
                    <div class="left-image">
                      <a href="<?= base_url() ?>/content/?prov=<?= $row->province_id ?>"><img src="<?= base_url() ?>/database/landmark/landmark_<?= $row->landmark_id ?>.jpg" alt=""></a>
                    </div>
                    <div class="right-content align-self-center">
                      <a href="../../#">
                        <h4><?= $row->landmark_name ?></h4>
                      </a>
                      <h6><?= substr($row->landmark_info, 0, 200) ?>...</h6>
                    </div>
                  <?php } ?>
                </div>
              </div>
              <div class="col-lg-12">
                <div class="listing-item">
                  <?php
                 foreach ($latestdance as $row) { ?> 
                    <div class="left-image">
                      <a href="<?= base_url() ?>/content/?prov=<?= $row->province_id ?>"><img src="<?= base_url() ?>/database/dance/dance_<?= $row->dance_id ?>.jpg" alt=""></a>
                    </div>
                    <div class="right-content align-self-center">
                      <a href="../../#">
                        <h4><?= $row->dance_name ?></h4>
                      </a>
                      <h6><?= substr($row->dance_info, 0, 200) ?>...</h6>
                    </div>
                  <?php } ?>
                </div>
              </div>
