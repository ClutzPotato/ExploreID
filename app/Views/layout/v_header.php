        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    ...
                    <div class="info">
                        <b class="text-muted">Session: <?= session()->get('user_name') ?> Status: <?= session()->get('user_status') ?></b>
                    </div>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="table?table=house" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>House</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="table?table=dance" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Dance</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="table?table=song" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Songs</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="table?table=instrument" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Instrument</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="table?table=landmark" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Landmark</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="table?table=food" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Food</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="table?table=story" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Story</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="table?table=taboo" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Taboo</p>
                            </a>
                        </li>
