    ...
    <div class="modal-content">
      ...
      <form action="<?= base_url() ?>/request/saveEditData" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
            <a id="request_img" href="" data-lightbox="image-1" class="form-control">View</a>
            </div>
          </div>
        <div class="modal-footer">
        <button type="submit"name="buttontype" value='edit' class="btn btn-primary">Edit this Request</button>
          <button type="submit"  name="buttontype" value='accept' class="btn btn-primary">Accept and Transfer to Main Tables</button>
