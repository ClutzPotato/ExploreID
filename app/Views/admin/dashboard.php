...
<div class="container-fluid">
    <h5 class="pt-3 mb-3">Settings</h5>
    <b>Change Weekly Featured Province Here:</b>
    <form action="<?= base_url() ?>/dashboard/saveSettings" method="post"> 
    <select name="province_id" class="form-select" aria-label="provinceid" onchange="this.form.click()" style="font-size: larger;" required>
    <?php foreach($settings as $row){  ?>
    <option selected value='<?= $row['settings_value'] ?>'>Current weekly province id: <?= $row['settings_value']; }?></option>
