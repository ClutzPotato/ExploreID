        ...
        <div class="card">
          ...
          <div class="card-body">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->province_id . '/province') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->province_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEditprovince" id="btnEditData" vid="<?= $data->province_id ?>" vtable="province"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
            ...
            <?php if ($table == 'clothes') { ?>
              <div class="p-3">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAddclothes" type="button"><i class="fa fa-plus"></i>&nbsp; Add new data</button>
              </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->clothes_id . '/clothes') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->clothes_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEditclothes" id="btnEditData" vid="<?= $data->clothes_id ?>" vtable="clothes"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
            ...
            <?php if ($table == 'house') { ?>
              <div class="p-3">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAddhouse" type="button"><i class="fa fa-plus"></i>&nbsp; Add new data</button>
              </div>
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->house_id . '/house') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->house_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEdithouse" id="btnEditData" vid="<?= $data->house_id ?>" vtable="house"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
            ...
            <?php if ($table == 'dance') { ?>
              <div class="p-3">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAdddance" type="button"><i class="fa fa-plus"></i>&nbsp; Add new data</button>
              </div>
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->dance_id . '/dance') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->dance_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEditdance" id="btnEditData" vid="<?= $data->dance_id ?>" vtable="dance"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
            ...
            <?php if ($table == 'song') { ?>
              <div class="p-3">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAddsong" type="button"><i class="fa fa-plus"></i>&nbsp; Add new data</button>
              </div>
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->song_id . '/song') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->song_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEditsong" id="btnEditData" vid="<?= $data->song_id ?>" vtable="song"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
            ...
            <?php if ($table == 'instrument') { ?>
              <div class="p-3">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAddinstrument" type="button"><i class="fa fa-plus"></i>&nbsp; Add new data</button>
              </div>
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->instrument_id . '/instrument') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->instrument_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEditinstrument" id="btnEditData" vid="<?= $data->instrument_id ?>" vtable="instrument"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
            ...
            <?php if ($table == 'landmark') { ?>
              <div class="p-3">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAddlandmark" type="button"><i class="fa fa-plus"></i>&nbsp; Add new data</button>
              </div>
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->landmark_id . '/landmark') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->landmark_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEditlandmark" id="btnEditData" vid="<?= $data->landmark_id ?>" vtable="landmark"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
            ...
            <?php if ($table == 'food') { ?>
              <div class="p-3">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAddfood" type="button"><i class="fa fa-plus"></i>&nbsp; Add new data</button>
              </div>
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->food_id . '/food') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->food_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEditfood" id="btnEditData" vid="<?= $data->food_id ?>" vtable="food"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
            ...
            <?php if ($table == 'story') { ?>
              <div class="p-3">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAddstory" type="button"><i class="fa fa-plus"></i>&nbsp; Add new data</button>
              </div>
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->story_id . '/story') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->story_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEditstory" id="btnEditData" vid="<?= $data->story_id ?>" vtable="story"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
            ...
            <?php if ($table == 'taboo') { ?>
              <div class="p-3">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAddtaboo" type="button"><i class="fa fa-plus"></i>&nbsp; Add new data</button>
              </div>
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= base_url('/table/deleteData/' . $data->taboo_id . '/taboo') ?>" class="btn btn-sm btn-danger float-right ml-1" onclick="return confirm('Do you want to delete data ID:<?= $data->taboo_id ?> ?')"> <i class="fas fa-trash-alt"></i></a>
                          <a class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modalEdittaboo" id="btnEditData" vid="<?= $data->taboo_id ?>" vtable="taboo"> <i class="fas fa-edit"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
          ...
          <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <fieldset>
                  <br>
                  <select name="province_id" class="form-select" aria-label="province" onchange="this.form.click()" style="font-size: larger;" required>
            ...
            <?php if ($tableadd != "taboo") { ?>
              <div class="form-group row">
                <label class="col-sm-3 col-form-label"><?= $tableadd ?> Name</label>
                <div class="col-md-8"><input type="text" class="form-control" name="<?= $tableadd ?>_name" placeholder="<?= $tableadd ?> Name" required></div>
              </div>
            <?php } ?>
            <div class="form-group row">
              <label class="col-sm-3 col-form-label"><?= $tableadd ?> Info</label>
              <div class="col-md-8"><input type="text" class="form-control" name="<?= $tableadd ?>_info" placeholder="<?= $tableadd ?> Description" required></div>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
    ...
    <div class="modal-content">
      ...
      <form action="<?= base_url() ?>/table/saveEditData" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
            <a id="province_img" href="" data-lightbox="image-1" class="form-control">View</a>
            </div>
          </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
      ...
      <div class="modal-content">
        ...
        <form action="<?= base_url() ?>/table/saveEditData" method="post">
          <div class="modal-body">
            <input type="hidden" name="table" value="<?= $tableadd ?>">
            <div class="form-group row">
              <label class="col-sm-3 col-form-label"><?= $tableadd ?> ID</label>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <fieldset>
                  <br>
                  <select name="province_id" class="form-select" aria-label="province" onchange="this.form.click()" style="font-size: larger;" required>
                    <option disabled selected hidden id="<?= $tableadd ?>_province_id" value="">-No Change-</option>
                    <option value="1">1 - Aceh</option>
                    <option value="2">2 - Sumatra Utara</option>
                    <option value="3">3 - Sumatra Selatan</option>
                    <option value="4">4 - Sumatra Barat</option>
          ...
          <div class="form-group row">
            <label class="col-sm-3 col-form-label">Image</label>
            <div class="col-md-8">
            <a id="<?= $tableadd ?>_img" href="" data-lightbox="image-1" class="form-control">View</a>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
